app.controller('MainController',
  ...
  //   show: false,
  //   templateUrl: 'tpl/partials/alert-introduction.html',
  ...
  //   title: 'Hi there!',
  //   content: 'You like what you see and interested in using our theme? You can find it at <a href="http://themeforest.net/item/materialism-angular-bootstrap-admin-template/11322821" target="_blank"><img style="height:20px;" src="img/icons/themeforest-icon.png" /> Themeforest</a>.',
  //   placement: 'top-right',
  //   type: 'theme',
  //   container: '.alert-container-top-right',
  //   show: false,
